...
- Crea la clase de la acción en el paquete `org.example.testespacial3.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="org.example.testespacial3.acciones.MostrarImporte"/>
</controlador>
```

```java
package org.example.testespacial3.acciones;
...
- ✅ Coloca las clases de acción en `org.example.testespacial3.acciones`
...
```java
package org.example.testespacial3.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `org.example.testespacial3.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
