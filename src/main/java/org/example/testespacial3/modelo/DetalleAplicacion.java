...
@Getter
@Setter
@Table(name = "detalleaplicacion")
public class DetalleAplicacion {

	@Id
	@Hidden
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "detalleaplicacionid")
	private int id;
	...
	@OneToMany(mappedBy = "detalleAplicacion", cascade = CascadeType.ALL)
	@ListProperties("pregunta.id, opcion")
